...
from bokeh.models import BoxSelectTool, LassoSelectTool, CustomJS, CheckboxGroup,\
                        ...
                        IndexFilter, CDSView, Div, Paragraph, Span
...
def make_paga_plot(data,use_label):
    ...
    header = Div(text="""<h2>PAGA plot: </h2>""",
    ...
    scanpy.pl.paga(data, color=use_label,ax=a,show=False,edge_width_scale=3.5, 
        node_size_scale=3.5)
    a.axis('off')
    ...
    fig.savefig("stlearn/static/tmp.png", dpi=150,
                bbox_inches='tight', pad_inches=0)

    paga = Div(text="""<img src='stlearn/static/tmp.png' style='float: left;'>""")
    ...
    scanpy.pl.draw_graph(data, color="louvain", legend_loc='on data',ax=a2,show=False,
        )
    a2.axis('off')
    fig2.set_size_inches(5,5)

    fig2.savefig("stlearn/static/tmp2.png", dpi=150,
                bbox_inches='tight', pad_inches=0)

    fa2 = Div(text="""<img src='stlearn/static/tmp2.png'>""")
