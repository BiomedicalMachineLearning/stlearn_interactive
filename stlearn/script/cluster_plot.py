...
from bokeh.models import BoxSelectTool, LassoSelectTool, CustomJS, CheckboxGroup,\
                        ...
                        IndexFilter, CDSView, Div, Paragraph, Span, HoverTool
...
def make_cluster_plot(data,use_label):
    ...
    def make_fig(list_index):
        fig = figure(title="Cluster plot",
                     x_range=(0,dim), y_range=(dim,0),
        ...
        fig.scatter(x='x',y='y',source=s1,size=5,color='color',legend_group="cluster",
    ...
    header = Div(text="""<h2>Clustering result plot: </h2>""",
